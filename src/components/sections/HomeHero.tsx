        ...
        <div className="relative py-14 sm:py-20 grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <a
                href="/programmes"
                className="inline-flex items-center rounded-xl bg-neutral-900 px-5 py-3 text-sm font-semibold text-white hover:bg-neutral-800 transition"
              >
                Explore Programmes
              </a>
              <a
                href="/about"
                className="inline-flex items-center rounded-xl border border-neutral-300 bg-white px-5 py-3 text-sm font-semibold text-neutral-900 hover:bg-neutral-50 transition"
              >
                About the Centre
              </a>
            </div>
            ...
            <div className="mt-8 text-sm text-neutral-600">
              <p>
                <span className="font-semibold text-neutral-900">Established:</span>{" "}
                {site.established} •{" "}
                <span className="font-semibold text-neutral-900">Allocation:</span>{" "}
                {site.allocation}
              </p>
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-neutral-200 bg-white shadow-sm p-6 sm:p-8">
            ...
            <div className="mt-5 text-sm text-neutral-600">
              <p className="font-semibold text-neutral-900">Media Spotlight</p>
              <p className="mt-1">
